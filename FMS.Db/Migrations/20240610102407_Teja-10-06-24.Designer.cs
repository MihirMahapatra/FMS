...
namespace FMS.Db.Migrations
{
    ...
    [Migration("20240610102407_Teja-10-06-24")]
    partial class Teja100624
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Party", b =>
                {
                    ...
                    b.Property<Guid?>("Fk_PartyGroupId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("Fk_PartyType")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("Fk_RefarenceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Fk_PartyGroupId");

                    b.HasIndex("Fk_PartyType");

                    b.HasIndex("Fk_RefarenceId");
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.PartyGroup", b =>
                {
                    ...
                    b.HasKey("PartyGroupId");

                    b.ToTable("PartyGruops", "dbo");

                    b.HasData(
                        new
                        {
                            PartyGroupId = new Guid("f38ea62e-d4a8-4d0c-9c3d-9e33f8b9f4e5"),
                            PartyGroupName = "Water Tank"
                        },
                        new
                        {
                            PartyGroupId = new Guid("6e23176b-af17-4c7b-b2b2-437b284d80df"),
                            PartyGroupName = "Door Frame"
                        },
                        new
                        {
                            PartyGroupId = new Guid("a9873f41-79b2-4ec7-ae94-82bc12d2dbb7"),
                            PartyGroupName = "General"
                        },
                        new
                        {
                            PartyGroupId = new Guid("c9e8d76f-3d1b-4a97-bab1-f99e56c672ff"),
                            PartyGroupName = "WH"
                        });
                });
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Referance", b =>
                {
                    b.Property<Guid>("RefaranceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.HasKey("RefaranceId");

                    b.ToTable("Referances", "dbo");
                });
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SalesReturnTransaction", b =>
                {
                    ...
                    b.Property<Guid?>("Fk_SubProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.OutwardSupplyTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.Unit", null)
                        .WithMany("OutwardSupplyTransactions")
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.Party", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.PartyGroup", "PartyGroup")
                        .WithMany("Parties")
                        .HasForeignKey("Fk_PartyGroupId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("FMS.Db.DbEntity.Referance", "Referance")
                        .WithMany("Parties")
                        .HasForeignKey("Fk_RefarenceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FMS.Db.DbEntity.SalesReturnTransaction", b =>
                {
                    ...
                    b.HasOne("FMS.Db.DbEntity.Product", "SubProduct")
                        .WithMany()
